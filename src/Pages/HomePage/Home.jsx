...
const Home = () => {
  ...
  return (
    <div className="bg-custom-gradient min-h-screen flex flex-col justify-center items-center h-full w-full">
      <Narbar />
      <div className="bg-custom-gradient min-h-screen flex flex-col justify-center items-center h-full w-full">
        <div className="flex flex-col items-center justify-center p-6 md:p-10 lg:p-24 xl:p-28 3xl:p-64">
          <h1 className="text-black text-center p-10 text-xl font-bold md:text-3xl md:p-18 lg:text-5xl lg:p-19 xl:text-7xl xl:p-12 3xl:text-9xl 3xl:p-14">
          ...
          <h2 className="flex items-center justify-center text-center font-normal text-base md:text-xl md:p-5 lg:text-2xl lg:p-10 xl:text-3xl xl:p-12 3xl:text-5xl 3xl:p-14">
            Not organized? Join millions of people to capture ideas, <br /> organize tasks, and do something creative.
          </h2>
          <button className="relative flex h-[50px] w-40 items-center justify-center overflow-hidden bg-blue-800 text-white shadow-2xl transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-custom-gradient before:duration-500 before:ease-out hover:shadow-custom-background hover:text-black hover:before:h-72 hover:before:w-72 rounded-3xl 3xl:h-28 3xl:w-[30rem] 3xl:text-5xl">
        ...
        <div className="w-full flex justify-center items-center mt-40" id="todo-section" data-animate>
          <div className={`flex flex-col md:flex-row justify-around items-center h-full xl:h-[39rem] xl:w-[94rem] bg-yellow-50 shadow-custom-background text-black relative shadow-xl font-mono w-full md:w-4/5 lg:w-3/4 3xl:w-1/2 p-6 transition-all duration-1000 ${
            ...
            <div className="flex items-start justify-start flex-col p-10 gap-5 xl:mt-28">
              <h1 className="text-blue-500 xl:text-2xl 3xl:text-2xl">Todo List</h1>
              <h2 className="font-bold text-lg md:text-2xl xl:text-5xl 3xl:text-4xl">
                Organize everything in <br /> your life
              </h2>
              <p className="font-light md:text-xl 3xl:text-2xl xl:text-xl">
        ...
        <div className="xl:mt-40 h-full xl:h-[50rem] bg-white flex items-center justify-around gap-8 p-8 w-full " id="tutorial-section" data-animate>
          ...
          <div 
            className={`flex justify-center items-center w-full xl:w-[45rem] xl:h-[30rem] bg-gray-200 rounded-xl shadow-xl overflow-hidden transition-all duration-1000 ${
              isVisible['tutorial-section'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            }`}
          >
            <video 
              src="/images/Download (2).mp4" 
        ...
        <div className="w-full p-8 mt-16 xl:h-[50rem] xl:mt-44" id="stats-section" data-animate>
          <div className={`max-w-7xl mx-auto transition-all duration-1000 ${
            isVisible['stats-section'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold text-blue-500 mb-2">In it for the long haul</h2>
              <h3 className="text-3xl font-bold mb-4">A todo web app you can trust for life</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {statsData.map((stat, index) => (
                <div
                  key={index}
                  className={`relative bg-white rounded-xl p-6 shadow-lg transition-all duration-500 transform hover:-translate-y-2 hover:shadow-xl ${
        ...
        <div className="flex items-center justify-center flex-wrap gap-8 p-8 mt-16">
          {[
            {
              name: "John Doe",
              image: "/images/pexels-black-wolf-1248959017-30235318.jpg", 
            ...
            <div
              ...
              id={`card-${index}`}
              data-animate
              className={`xl:w-[28rem] w-[22rem] bg-white xl:h-[28rem] h-[auto] rounded-2xl shadow-xl shadow-custom-background flex justify-start items-start p-6 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 ${
            ...
            >
              <div className="flex flex-col gap-4 w-full">
                ...
                <p className="text-lg text-gray-600 my-4">{review.review}</p>
        ...
        <div className="flex items-center justify-center flex-col gap-8 p-8 mt-16 h-full xl:h-[20rem] xl:mt-32 bg w-full mb-20">
          <h1 className=" text-lg xl:text-2xl">What To Grab More Of What Our Platform Can Offer</h1>
          <button className="w-28 h-10 xl:w-52 rounded-2xl xl:h-12 bg-blue-600 text-white hover:bg-blue-800">Get Started</button>
        </div>
