...
const Home = () => {
  ...
  const features = [
    {
      ...
      title: "Goal Setting",
      description:
        "Set clear objectives and track your progress with smart goal management."
    },
    {
      icon: Calendar,
      title: "Smart Scheduling",
      description:
        "Organize your time efficiently with intelligent scheduling features."
    },
    {
      icon: BarChart3,
  ...
  return (
    <div className={`min-h-screen ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center mb-16">
                ...
                <button
                  className={`group px-8 py-4 border-2 font-semibold rounded-full transition-all duration-300 flex items-center justify-center gap-3 min-w-[200px] ${
                    theme === "dark"
                      ? "border-gray-600 text-gray-300 hover:border-gray-500 hover:text-gray-200 hover:bg-gray-800"
                      : "border-gray-300 text-gray-700 hover:border-gray-900 hover:text-gray-900 hover:bg-gray-50"
                  }`}
                >
              ...
              <div
                className={`flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 text-sm ${
            ...
            <div className="relative">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      >
                        {t("Review project proposal")}
                      </h4>
                      <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                        {t("Completed • Verified by Sarah")}
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
                        {t("Update client presentation")}
                      </h4>
                      <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                        {t("In Progress • Assigned to Mike")}
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div
                    className={`group flex items-center gap-4 p-4 rounded-xl border transition-all duration-300 hover:shadow-md ${
                      theme === "dark"
                        ? "bg-gradient-to-r from-orange-900/20 to-amber-900/20 border-orange-700"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className={`font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>
                        {t("Code review for API")}
                      </h4>
                      <p className={`text-sm ${theme === "dark" ? "text-gray-300" : "text-gray-600"}`}>
                        {t("Pending Review • Waiting for John")}
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <div
                className={`absolute -top-4 -right-4 w-20 h-20 rounded-full flex items-center justify-center shadow-xl animate-bounce ${
              ...
              <div
                className={`absolute -bottom-4 -left-4 w-16 h-16 rounded-full flex items-center justify-center shadow-xl animate-pulse ${
      ...
      <section
        id="features"
        className={`py-20 px-6 ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`}
      >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p
                className={`${theme === "dark" ? "text-gray-300" : "text-gray-700"} text-xl mb-8 leading-relaxed`}
              >
                {t(
            ...
            <div className="relative">
              <div
                className={`${theme === "dark" ? "bg-gray-800" : "bg-gray-100"} aspect-video rounded-2xl shadow-2xl overflow-hidden`}
              >
                <video
              ...
              <div
                className={`${theme === "dark" ? "bg-gray-600" : "bg-gray-300"} absolute -bottom-6 -right-6 w-24 h-24 rounded-full flex items-center justify-center shadow-lg`}
              >
...
>
  <div className="w-full max-w-7xl mx-auto text-center">
    ...
    <div className={`mt-16 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                {t("About Tasky.Dev").split(" Tasky.Dev")[0]}
                <span className="font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-6">
                  Tasky.Dev
                </span>
              </h2>
              <p
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`text-gray-600 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
                      {t("To empower everyone to reach their full potential by providing intuitive tools that simplify complex workflows and boost productivity.")}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`text-gray-600 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
                      {t("We believe in simplicity, reliability, and user-centric design. Every feature is built with your success in mind.")}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className={`text-gray-600 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}>
                      {t("To become the world's most trusted productivity platform, helping millions achieve their goals and dreams.")}
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <div className={`rounded-2xl p-8 shadow-xl ${theme === "dark" ? "bg-gray-800" : "bg-gray-50"}`}>
              <h3
                className={`text-2xl font-bold mb-6 text-center ${
                  theme === "dark" ? "text-white" : "text-gray-900"
                }`}
              >
                {t("Why Choose Tasky.Dev?")}
              </h3>
              <div className="space-y-4">
                {["Intuitive and easy to use", "Powerful collaboration tools", "Real-time progress tracking", "Secure and reliable platform", "24/7 customer support"].map((text, i) => (
                  <div
                    key={i}
      ...
      {/* CTA Section */}
      <section className={`py-20 px-6 ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}>
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            {t("Ready to Transform Your Productivity?")}
          </h2>
          <p className={`${theme === "dark" ? "text-gray-300" : "text-gray-600"} text-xl mb-8 max-w-3xl mx-auto`}>
